...
class _AllMatchesScreenState extends ConsumerState<AllMatchesScreen> {
  ...
  List<ScorerMatch> get _filtered {
    ...
    return _matches.where((m) {
      ...
      return a.contains(q) || b.contains(q) || m.venue.toLowerCase().contains(q);
    }).toList();
  }
                  ...
                  child: _filtered.isEmpty
                      ...
                      : RefreshIndicator(
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (_, i) => _MatchTile(match: _filtered[i], teamName: _teamName),
                          ),
                        ),
                ),
              ],
...
class _MatchTile extends StatelessWidget {
  ...
  const _MatchTile({required this.match, required this.teamName});

  @override
  Widget build(BuildContext context) {
    final isLive =
        match.status == MatchStatus.live || match.status == MatchStatus.inProgress;
    return Container(
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: isLive ? AppColors.liveRed.withValues(alpha: 0.2) : AppColors.pitchGreen.withValues(alpha: 0.15),
