...
const _faqs = [
  (
    'How do I Go Live?',
    'Tap the Go Live button from Profile or the bottom navigation. You can stream from your own device camera to viewers within the app.'
  ),
  (
    'Is my data saved?',
  ...
  (
    ...
    'Scores are updated in real-time from live match data sources.'
  ),
  (
    'Can I watch other people\'s streams?',
    'Yes! Streams from other broadcasters who are streaming their own camera feeds (club matches, academy games, etc.) appear in the Live Viewer section.'
  ),
];
